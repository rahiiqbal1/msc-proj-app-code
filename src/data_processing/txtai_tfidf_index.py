...
def main() -> None:
    ...
    index_save_path: str = os.path.join(
        wikidata_dir, "poc_txtai_tfidf_index.pkl"
    )
    ...
    # Indexing and saving:
    txtai_tfidf_index_pickle(
        pickled_jsons_path, index_save_path, fields_to_use
    )

    sys.exit(0)

def txtai_tfidf_index_pickle(
    ...
    # Indexing:
    tfidf_scoring = ScoringFactory.create({"method": "tfidf", "terms": True})
    tfidf_scoring.index(
    ...
    tfidf_scoring.save(index_save_path)
